 ...
 *  - randomBelow: все значения < max; равномерность — грубый smoke
 *    (±30% ловит только сильные перекосы; настоящая защита от modulo-bias —
 *    структурный rejection sampling и range-check в randomBelow);
